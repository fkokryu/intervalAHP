    ...
    for i in unique_trial_numbers
        ...
        for m =1:k
            ...
            if(m!=k)
                ...
                optimalval_perfect_entani = solvePerfectIncorporationLP(A).optimalValue_perfect_entani
                optimalval_tperfect = solvetPerfectIncorporationLP2(A).optimalValue_tperfect_center_1
                t_tperfect = solvetPerfectIncorporationLP2(A).s_tperfect_center_1
